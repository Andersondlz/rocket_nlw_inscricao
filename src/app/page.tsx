...
export default function Home() {
  return (
    <main className="max-w-[1120px] mx-auto px-5 py-8 md:py-0" >
      <div className="min-h-dvh flex flex-col justify-center gap-16">
        <div className="flex flex-col gap-8 items-center md:items-start">
          <Image src={logo} alt="logo da devstage" width={108.5} height={30} />
          <h1 className="text-4xl text-center text-gray-100 font-heading font-medium flex flex-col leading-none md:text-7xl md:text-left">
        ...
        <div className="flex gap-5 items-stretch flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-gray-200 text-xl font-heading font-semibold">Sobre o Evento</h2>
              <span className="text-purple font-semibold text-xs md:text-sm flex items-center gap-2">
